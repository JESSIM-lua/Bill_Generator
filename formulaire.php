...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO form (date, var, nom, prenom, autre, autre2, autre3, autre4, autre5, autre6, DebutAcc)
    VALUES ('$date', '$var', '$nom', '$prenom', '$autre', '$autre2', '$autre3', '$autre4', '$autre5', '$autre6', '$DebutAcc')";
...
$autre4 = isset($_POST["autre4"]) ? sanitizeInput($_POST["autre4"]) : '';
$autre5 = isset($_POST["autre5"]) ? sanitizeInput($_POST["autre5"]) : '';
$autre6 = isset($_POST["autre6"]) ? sanitizeInput($_POST["autre6"]) : '';
